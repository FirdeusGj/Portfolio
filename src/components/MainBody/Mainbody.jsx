      ...
      <div className="mainbody-wrapper">
        <div className="introduction">
          ...
          <div className="introduction-links">
            <a className="introduction-link" href="https://github.com/FirdeusGj" target="_blank">
              <svg
            ...
            <a className="introduction-link" href="https://drive.google.com/file/d/16fOFFY5AZf6ir5IM_XMw2xGMUkruPFVM/view?usp=drive_link" target="_blank">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                height="1em"
                viewBox="0 0 384 512"
            ...
            <a className="introduction-link" href="#contact">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                height="1em"
                viewBox="0 0 512 512"
